...
class Bbox:
    ...
    def getBoundingBoxesForImg(self,bgr_img):
        ...
        contours_filtered, contours_filtered_img = ipbasics.filterContours(mask_open, contours, mult=-0.5, mode='UP')
